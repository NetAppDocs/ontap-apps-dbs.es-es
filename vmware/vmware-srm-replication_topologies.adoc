...
Para obtener la información más reciente sobre SnapMirror y SnapVault para ONTAP 9, consulte https://www.netapp.com/pdf.html?item=/media/17229-tr-4015-snapmirror-configuration-ontap.pdf["TR-4015 Guía de mejores prácticas para la configuración de SnapMirror para ONTAP 9."^]
