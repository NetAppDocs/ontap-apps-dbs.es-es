...
Para obtener más información sobre las ventajas del diseño y despliegue simétrico o asimétrico, consulte la https://docs.netapp.com/us-en/ontap/smbc/index.html["Documentación de SnapMirror Active Sync"].
