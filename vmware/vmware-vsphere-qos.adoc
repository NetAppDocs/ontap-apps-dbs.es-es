...
*Nota:* vVols requiere el uso de herramientas de ONTAP para VMware vSphere que funciona como proveedor VASA para ONTAP. Consulte link:/vmware/vmware-vvols-overview.html["VMware vSphere Virtual Volumes (vVols) con ONTAP"] Para ver las mejores prácticas de vVols.
