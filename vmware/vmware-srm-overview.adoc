...
NOTE: Aunque los sistemas ONTAP le permitirán emparejar SVM en el mismo clúster para la replicación de SnapMirror, ese escenario no se ha probado ni certificado con SRM. Por lo tanto, se recomienda usar solo SVM de diferentes clústeres cuando se utilice SRM.
