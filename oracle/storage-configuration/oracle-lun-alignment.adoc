...
Consulte también la sección sobre la alineación de los bloques de compresión link:/oracle/ontap-configuration/oracle-efficiency.html["Eficiencia"]. Cualquier diseño alineado con los límites de bloques de compresión de 8KB KB también se alineará con los límites de 4KB KB.
