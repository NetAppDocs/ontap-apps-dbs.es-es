...
summary: Configuración de Oracle y TCP/IP y Ethernet en sistemas ASA r2 
searchtitle: Configuración de TCP/IP y Ethernet para bases de datos Oracle con ASA r2 
---
...
TIP: * NetApp recomienda* asegurarse de que los controladores de almacenamiento NetApp ASA r2 no reciban paquetes de control de flujo Ethernet. Generalmente, esto se puede hacer configurando los puertos del conmutador a los que está conectado el controlador, pero algunos componentes del conmutador tienen limitaciones que podrían requerir cambios del lado del cliente.
