...
image:smas-overview.png["Información general sobre sincronización activa de SnapMirror"]
...
image:smas-logical.png["Diseño lógico de sincronización activa de SnapMirror"]
