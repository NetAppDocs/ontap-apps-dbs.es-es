...
image:./media/file-structure1.png["Error: No se ha encontrado la imagen gráfica"]
...
image:./media/file-structure2.png["Error: No se ha encontrado la imagen gráfica"]
