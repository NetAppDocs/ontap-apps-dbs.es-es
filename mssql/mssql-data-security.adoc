...
[role="lead"]
Proteger un entorno de base de datos es un esfuerzo multidimensional que va más allá de gestionar la propia base de datos. NetApp ofrece varias funciones únicas diseñadas para proteger el aspecto de almacenamiento de la infraestructura de bases de datos.
