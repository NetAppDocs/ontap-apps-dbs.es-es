...
summary: Microsoft SQL Server y ONTAP Mediator 
searchtitle: Microsoft SQL Server y ONTAP Mediator 
---
= Mediador ONTAP
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
Mediator es necesario para automatizar la recuperación tras fallos de forma segura. Lo ideal sería que se ubicara en un sitio 3rd independiente, pero todavía puede funcionar para la mayoría de las necesidades si se ubicara con uno de los clústeres que participan en la replicación.
